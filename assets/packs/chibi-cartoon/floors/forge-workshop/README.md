...
2. Variety across the book is what keeps KDP's duplicate-content check
   quiet. One floor per room type means every forge-workshop in every book is
   identical. Shigai Royalty ships eight per room type.

Name them `forge-workshop-01.png`, `forge-workshop-02.png`, ... Lower case, hyphens.
