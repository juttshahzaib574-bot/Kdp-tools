...
2. Variety across the book is what keeps KDP's duplicate-content check
   quiet. One floor per room type means every library-study in every book is
   identical. Shigai Royalty ships eight per room type.

Name them `library-study-01.png`, `library-study-02.png`, ... Lower case, hyphens.
