...
2. Variety across the book is what keeps KDP's duplicate-content check
   quiet. One floor per room type means every servants-quarters in every book is
   identical. Shigai Royalty ships eight per room type.

Name them `servants-quarters-01.png`, `servants-quarters-02.png`, ... Lower case, hyphens.
