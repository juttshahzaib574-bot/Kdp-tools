...
These are the 5 the procedural engine draws today, and they are a
...
2. Variety across the book is what keeps KDP's duplicate-content check
   quiet. One floor per room type means every barn-stable in every book is
   identical. Shigai Royalty ships eight per room type.

Name them `barn-stable-01.png`, `barn-stable-02.png`, ... Lower case, hyphens.
