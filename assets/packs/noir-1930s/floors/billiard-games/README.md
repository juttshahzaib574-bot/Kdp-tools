...
2. Variety across the book is what keeps KDP's duplicate-content check
   quiet. One floor per room type means every billiard-games in every book is
   identical. Shigai Royalty ships eight per room type.

Name them `billiard-games-01.png`, `billiard-games-02.png`, ... Lower case, hyphens.
