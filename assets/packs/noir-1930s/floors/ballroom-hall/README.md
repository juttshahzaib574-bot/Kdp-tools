...
2. Variety across the book is what keeps KDP's duplicate-content check
   quiet. One floor per room type means every ballroom-hall in every book is
   identical. Shigai Royalty ships eight per room type.

Name them `ballroom-hall-01.png`, `ballroom-hall-02.png`, ... Lower case, hyphens.
