...
- wood plank
- burlap / sacking
- packed earth / furrows

These are the 4 the procedural engine draws today, and they are a
...
2. Variety across the book is what keeps KDP's duplicate-content check
   quiet. One floor per room type means every hayloft-coop in every book is
   identical. Shigai Royalty ships eight per room type.

Name them `hayloft-coop-01.png`, `hayloft-coop-02.png`, ... Lower case, hyphens.
